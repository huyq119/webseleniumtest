...
class AddDepartmentPage(BasePage):
    ...
    def add_department(self, title):
        ...
        self.find(By.CSS_SELECTOR, "div.ww_dialog_body div.jstree-default").click()
        self.find(By.CSS_SELECTOR, "div.ww_dialog_foot a.ww_btn_Blue").click()
        # 添加显示等待，等待alert消失后操作
        WebDriverWait(self.driver, 5).until(expected_conditions.element_to_be_clickable((By.CSS_SELECTOR, ".member_colRight_cnt_operation a.js_add_member")))
